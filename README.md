...
Currently only N64 GameShark (aka Action Replay) ROMs are supported, but we hope to eventually support other consoles and device types as well (GBA, Xplorer 64, Code Breaker, etc.).
