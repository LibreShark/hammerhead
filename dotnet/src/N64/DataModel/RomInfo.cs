...
{
    public readonly N64GsRomVersion Version;
    ...
    public RomInfo(N64GsRomVersion version, List<Game> games, List<KeyCode> keyCodes, Checksum? checksum = null, KeyCode? activeKeyCode = null)
    {
        Version = version;
        Games = games;
        KeyCodes = keyCodes;
