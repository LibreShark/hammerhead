...
public partial class RomVersion
{
    ...
    private static RomVersion? KnownVersion(string raw)
    {
        ...
        {
            // Action Replay
            "14:56 Apr 15 98" => Of(raw, 1.11, null,       1998, 04, 15, 14, 56),
            "15:50 Mar 24 99" => Of(raw, 3.00, null,       1999, 03, 24, 15, 50),
            "16:08 Apr 18"    => Of(raw, 3.30, null,       2000, 04, 18, 16, 08),

            // GameShark
            "12:50 Aug 1 97"  => Of(raw, 1.02, null,       1997, 08, 01, 12, 50),
            "10:35 Aug 19 97" => Of(raw, 1.04, null,       1997, 08, 19, 10, 35),
            "16:25 Sep 4 97"  => Of(raw, 1.05, "Thursday", 1997, 09, 04, 16, 25),
            "13:51 Sep 5 97"  => Of(raw, 1.05, "Friday",   1997, 09, 05, 13, 51),
